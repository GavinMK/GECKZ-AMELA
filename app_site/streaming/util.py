...
def send_inbox_message(user):
    ...
    message_content = 'Dear ' + user.username + ', \nWe want to inform you that your subscriptions will expire in 5 days. Unsubscribe from all the shows you are done watching to free up subscription slots. If you do not unsubscribe, your current subscriptions will auto-renew for the next cycle.\nSincerely,\nThe Amela Development Team'
